export function usage(): void {
	...
	console.log(`       ${process.argv[1]} bundle [-c <config file>] [-o <output file or dir>] [--include-tag <tag>] [--exclude-tag <tag>] [--include-path <glob>] [--exclude-path <glob>] [--activate-extension <name>] [--remove-extension <pattern>] [<path or url to api spec> [<additional api spec> ...]]`)
}
