export function usage(): void {
	...
	console.log(`       ${process.argv[1]} bundle [-o <output file>] [--include-tag <tag>] [--exclude-tag <tag>] [--include-path <glob>] [--exclude-path <glob>] [--activate-extension <name>] [--remove-extension <pattern>] <path or url to api spec> [<additional api spec> ...]`)
}
