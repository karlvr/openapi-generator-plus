import { CodegenModel, CodegenState, CodegenOptions } from '@openapi-generator-plus/types'
...
export interface InternalCodegenState extends CodegenState<CodegenOptions> {
